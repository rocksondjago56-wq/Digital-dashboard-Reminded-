...
export const api = {
  ...
  auth: {
    ...
    activateAccount: (identifier, emailCode, phoneCode, password) => request('/auth/activate-account', { method: 'POST', body: JSON.stringify({ identifier, emailCode, phoneCode, password }) })
  },
