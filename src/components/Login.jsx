    ...
    try {
      if (isRegistering) {
        const required = profile.role === 'student'
          ? [profile.fullName, profile.indexNumber, profile.email, profile.program, profile.certificate, profile.year, profile.accessCode]
